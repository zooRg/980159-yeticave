<form class="form form--add-lot container<?php if ($_SERVER['REQUEST_METHOD'] == 'POST'): ?> form--invalid<? endif; ?>"
      action="/add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    <h2>Добавление лота</h2>
    <div class="form__container-two">
        <div class="form__item<?php if (!isset($_POST['lot']['name'])): ?> form__item--invalid<? endif; ?>">
            <!-- form__item--invalid -->
    ...
    <div class="form__item form__item--file<?php if (!isset($_POST['lot']['path'])): ?> form__item--invalid<? endif; ?>">
        <!-- form__item--uploaded -->
